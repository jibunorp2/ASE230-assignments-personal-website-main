...
<!-- Team Thumb-->
<div class="advisor_thumb"><a href="PROSPER_JIBUNOR.php"><img src="craig4.jpeg" alt=""></a>
<!-- Social Info-->
<div class="social-info"><a href="PROSPER_JIBUNOR.php"><i class="fa fa-facebook"></i></a><a href="detail.html"><i class="fa fa-twitter"></i></a><a href="detail.html"><i class="fa fa-linkedin"></i></a></div>
</div>
<!-- Team Details-->
<div class="single_advisor_details_info">
<h6><?php echo $name ?> </h6>
<p class="designation"> <?php echo "Founder & CEO" ?></p>
</div>
</div>
</div>
<!-- Single Advisor-->
...
<!-- Team Details-->
<div class="single_advisor_details_info">
<h6><?php echo "Nazrul Islam" ?></h6>
<p class="designation"><?php echo "UI Designer" ?></p>
</div>
</div>
</div>
<!-- Single Advisor-->
...
<!-- Team Details-->
<div class="single_advisor_details_info">
<h6><?php echo "Riyadh Khan" ?></h6>
<p class="designation"><?php echo "Developer" ?></p>
</div>
</div>
</div>
<!-- Single Advisor-->
...
<!-- Team Details-->
<div class="single_advisor_details_info">
<h6><?php echo "Niloy Islam" ?></h6>
<p class="designation"><?php echo "Marketing Manager" ?></p>
</div>
</div>
</div>
</div>
