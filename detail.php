...
print_r($_GET);
        // $array = array(
        //     $nameOf = "Prosper Jibunor",
        //     $nameOf2 = "Alex Lisa",
        //     $nameOf3 = "Teddy Amare",
        //     $info = "Prosper Watches the Power Rangers",
        //     $info2 = "Alex Lisa likes to hike", 
        //     $info3 = "Teddy Amare like to be late to class"
        // )

        $students = [["name"=>"Prosper Jibunor", "picture"=>"craig4.jpeg","position"=>"Junior(?)",'email'=>'jibunorp2@nku.edu','dream'=>'Pastor','company'=>'Wherever God sees best' ,'info'=>"My name is Prosper Jibunor, I am the 4th of 6 children in the Jibunor house. My parents were both born in Nigeria, my dad went to the University of Minnesota while my mother went to University of St. Denis. But they ended up meeting in Minnesota. I am a Christian and I love learning new things, whether about the Bible or anything else that I'm interested in. I also am a big fan of the Power Rangers, Teenage Mutant Ninja Turtles, and Craig of the Creek. And even though Tedla Tafari continually tries his best to undermind me I still show heart and resiliency.", 
      'skill1'=>'Power Rangers Fan', 'skill2'=>'Losing in FIFA', 'skill3'=>'Saving seats for my friends', 'quote'=>'No weapon formed against you shall prosper, and any tongue that rises against you thou shalt condemn. That is the heritage of the servants of the Lord. (Isaiah 54:17)',
    'funfact'=>'I love Love.', 'percentage1'=>'77%', 'percentage2'=>'17%', 'percentage3'=>'77%', 'pernum1'=>77, 'pernum2'=>17, 'pernum3'=>77],
      ...
      'skill1'=>'Being a Beatles fan', 'skill2'=>'Eating Bahklava', 'skill3'=>'Making Friends', 'quote'=>'I like dogs', 'funfact'=>'I am good with computers.','percentage1'=>'27%', 'percentage2'=>'77%', 'percentage3'=>'100%', 'pernum1'=>27, 'pernum2'=>77, 'pernum3'=>100],
        ["name"=>"Alex Lisa", "picture"=>"https://bootdey.com/img/Content/avatar/avatar6.png", 
        "position" => "Senior", 'email'=>'lisaa17@nku.edu','dream'=>'To be go to Comic con',
        'company'=>'Comic con','info'=>'Hello! I am Alex Lisa, did you know that I am the Vice-President of the COI Ambassadors at NKU and the president of the Women in Cyber Security NKU?!', 
        'skill1'=>'Being in a relationship', 'skill2'=>'Playing games', 'skill3'=>'Having people over',
        'quote'=>'I like cats', 'funfact'=>'I am good with computers too.', 'percentage1'=>'77%', 'percentage2'=>'17%', 'percentage3'=>'7%', 'pernum1'=>77, 'pernum2'=>17, 'pernum3'=>7]];
...
<html lang="en">
  ...
  <button type="button" class="btn btn-success"><a href="index.php"><?php echo "Go Back" ?></a></button>
